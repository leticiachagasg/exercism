...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    temperature_limit = temperature < 800
    neutrons_emitted_limit = neutrons_emitted > 500
    product_limit = temperature * neutrons_emitted < 500000
    
    if temperature_limit and neutrons_emitted_limit and product_limit:
        return True
    else:
        return False
